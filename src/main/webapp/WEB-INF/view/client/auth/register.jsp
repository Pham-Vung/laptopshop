                            ...
                            <div class="card-body">
                                <form:form method="post" action="/register" modelAttribute="registerUser">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input cssClass="form-control" id="inputLastName" type="text"
                                    ...
                                    <div class="form-floating mb-3">
                                        <form:input cssClass="form-control" id="inputEmail" type="email"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <form:input cssClass="form-control" id="inputPasswordConfirm" type="password"
